...
<section class="pt-11 mb-6 pt-lg-12 mb-lg-7" id=content>
    <div class=container>
        <div class=row>
            <div class=col>
                <h1 class=mb-n3>How can we help?</h1>
            </div>
        </div>
        <div class=row>
            <div class="col pt-5">
                <div class="bg-white shadow-lg">
                    <div class="row no-gutters">
                        <div class="col-lg-7 p-4 p-lg-6">
                            ...
                            <div class="row mx-n2">
                                <div class="col-md px-2 mb-3"><input class=form-control type=text
                                        placeholder="Full name" aria-label="Full name"></div>
                                <div class="col-md px-2 mb-3"><input class=form-control type=tel
                                        placeholder="Phone number" aria-label="Phone number"></div>
                            </div>
                            <div class="row mx-n2">
                                <div class="col-md px-2 mb-3"><input class=form-control type=email
                                        placeholder="Email address" aria-label="Email address"></div>
                                <div class="col-md px-2 mb-3"><input class=form-control type=text
                                        placeholder=Company aria-label=Company></div>
                            </div>
                            <div class="row mx-n2">
                                <div class="col px-2 mb-3"><textarea class=form-control rows=7
                                        placeholder=Message aria-label=Message></textarea></div>
                            </div>
                            <div class="row justify-content-between">
                                <div class=col-md>
                                </div>
                                <div class="col col-md-auto"><button type=button
                                        class="btn btn-secondary text-uppercase d-inline-flex align-items-center w-100">Send<svg
                                            width=16 height=16 class=ml-2 xmlns=http://www.w3.org/2000/svg
                                            viewBox="0 0 24 24">
                        ...
                        <div class="col-lg-5 position-relative bg-white z-index-1">
                            <div data-toggle=map data-options='{"center": [-119.8631919,36.8121287]}'
                                data-marker class="w-100 h-100 py-10"></div>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="mb-9 mb-lg-10">
    <div class=container>
        <div class="row mx-n3 justify-content-center text-center">
            <div class="col-md-6 col-lg-4 px-3 mb-3 mb-lg-0" data-aos=fade-up>
                <div class="card shadow bg-light h-100 lift">
                    <div class="card-body py-5 px-2"><svg width=40 height=40 class="fill-secondary mb-3"
                        ...
                        <p class="font-size-6 mb-0">561/64, New Bus stand,<br>Anuradhapura</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-4 px-3 mb-3 mb-lg-0" data-aos=fade-up data-aos-delay=50>
                <div class="card shadow bg-light h-100 lift">
                    <div class="card-body py-5 px-2"><svg width=40 height=40 class="fill-secondary mb-3"
                            xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24">
                        ...
                        <p class="font-size-6 mb-0">T: <a href=# class=text-reset>+94 (76) 960 7140</a></p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-4 px-3 mb-3 mb-md-0" data-aos=fade-up data-aos-delay=50>
                <div class="card shadow bg-light h-100 lift">
                    <div class="card-body py-5 px-2"><svg width=40 height=40 class="fill-secondary mb-4"
                            xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24">
                        ...
                        <p class=mb-0><a href=# class="text-reset text-decoration-none"><svg width=20 height=20
                                    class=mr-2 xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24">
                                ...
                                </svg> </a><a href=# class="text-reset text-decoration-none"><svg width=20
                                    height=20 class=mr-2 xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24">
                                ...
                                </svg> </a><a href=# class="text-reset text-decoration-none"><svg width=23
                                    height=23 xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24">
