<footer class="text-white bg-primary small">
    <div class="pt-6 pb-4 pt-lg-7 pb-lg-6">
        <div class=container>
            <div class="row justify-content-md-between">
                <div class="col-md-5 col-lg-4 d-flex flex-column justify-content-between">
                    <div class="mx-auto mt-4 mb-3 mt-lg-5 pt-lg-2 mx-md-0"><a href=#
                            class="text-reset text-decoration-none"><svg width=15 height=15 class=mx-1
                            ...
                            </svg> </a><a href=# class="text-white text-decoration-none"><svg width=15 height=15
                                class=mx-1 xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24">
    ...
    <div class="py-3 border-top border-gray">
        <div class=container>
            <div class="row justify-content-between small">
                <div class=col-auto><a data-scroll href=# >
                ...
                <div class=col-auto><span>&copy; Mr Wickramaarachchi Videography</span></div>
            </div>
        </div>
    </div>
</footer>
